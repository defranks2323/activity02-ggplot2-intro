...
**Response**:
The boxplot is much more solid but the jitter plot shows much more of an accurate spread
...
**Response**:
I prefer the jitter laid over the box plot because it looks much more clean than the other way. Also the box covers the points.
...
**Response**:
having it mapped in the ggplot will change the entire code while mapping it in the specific geom will only change that geom.
